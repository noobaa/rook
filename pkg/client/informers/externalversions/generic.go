...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case noobaarookiov1alpha1.SchemeGroupVersion.WithResource("systems"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Noobaa().V1alpha1().Systems().Informer()}, nil
